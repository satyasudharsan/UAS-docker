...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        ...
        <div class="bg-gray-200 mx-auto shadow rounded pb-4 ">
            <div class="mt-2 p-4 border-b border-grey-light text-center">
                <span id="city" class="text-3xl font-thin"></span>
            </div>
            <div class="text-center text-lg text-grey-light p-3 space-x-5">
            ...
            <div class="flex justify-center">
                <div class="text-center p-2">
                    <div class="text-lg text-grey-light">
                        <span id="min-temperature" class="text-right"></span>
                        <span id="temperature" class="text-center text-3xl text-slate-900 mx-6 font-thin"></span>
                        <span id="max-temperature" class="text-left"></span>
                    </div>
        ...
        <div id="locationModal" class="fixed z-10 inset-0 overflow-y-auto hidden">
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">
                                        Aplikasi ini membutuhkan akses lokasi untuk memberikan informasi rekomendasi tanaman hias. Mohon aktifkan lokasi pada perangkat Anda.
                                    </p>
                                </div>
                            </div>
                        </div>
