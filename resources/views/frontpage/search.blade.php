<x-green-layout>
    ...
    <section class="mx-12 md:mx-20 pb-10 item opacity-0 transition duration-1000 ease-in-out delay-300">
        <div class="px-2 pt-10 pb-10">
            <div class="md:mx-16 flex justify-center items-center mt-32">
                <div class="container mx-auto rounded-lg md:p-14">
                    <form action="{{route('search')}}" method="GET">
                        <h1 class="text-center font-bold md:text-3xl lg:text-4xl text-2xl">Cari Tanaman Hias</label>
                        <p class="mx-auto font-normal text-sm my-6 max-w-lg">Temukan tanaman hias sesuai suhu lokasi Anda. Pencarian mudah untuk kebun indah dengan rekomendasi tanaman yang tepat.</p>
                        <div class="flex border items-center bg-white rounded-lg overflow-hidden py-2 justify-between">
                            <input name="s" value="{{(isset($_GET['s']))?$_GET['s']:''}}" class="text-sm md:text-base text-gray-400 flex-grow outline-none px-4" type="text" placeholder="Cari Tanaman Hias" />
                            <div class="ms:flex items-center px-4 rounded-lg space-x-4 mx-auto ">
                                <button class="bg-green-500 text-white text-sm md:text-base rounded-lg px-4 py-2">Search</button>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="flex flex-wrap gap-x-4">
                <div class="md:mb-16 md:mx-16 relative z-10 mt-10">
                    <div class="flex justify-between pb-10 item opacity-0 transition duration-1000 ease-in-out delay-300">
                        <p class="text-gray-600 font-medium text-base md:text-lg lg:text-xl">Pencarian {{ $plants->count() }} tanaman yang ditemukan</p>
                    </div>
